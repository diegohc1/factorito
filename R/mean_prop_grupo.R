...
#' Promedio de una variable según grupos
#'
#'
...
#'
#' @return data frame con el promedio según grupo, la cantidad de casos (n) y porcentaje (prop)
#' @export
#'
#' @import dplyr
#'
...
mean_prop_grupo <- function(data, m, w = NULL, vis_na = TRUE){
